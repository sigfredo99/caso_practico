<div class="card shadow border-0 m-5">
    <div class="card-header bg-success bg-pattern text-white">
        <h4 class="m-2">Bancos</h4>
    </div>
    <div class="card-body m-4">
        <div class="col-sm-12 text-end">

            <button id="btnAdd" type="button" class="btn btn-success mb-4">Nuevo Banco</button>
        </div>
        <div class="col-sm-12">
            <div class="table-responsive">
                <table id="tableBanks" class="table table-striped table-bordered table-condensed" style="width:100%">
...
<div class="modal fade" id="modalAddEdit" tabindex="-1" role="dialog" aria-labelledby="modalAddEditLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="formBanks" class="needs-validation" novalidate>
